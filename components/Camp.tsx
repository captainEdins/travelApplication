...
export default function Camp() {
    return (
        ...
        relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
            <div className="flex hide-scrollbar h-[340px] w-full items-start
            ...
            <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
                ...
                overflow-hidden rounded-3xl">
                    <h2 className="text-white regular-24 md:regular-32
                    xl:regular-64 capitalize">
                        <strong>Feeling Lost </strong>
                        And Not Knowing The Way?</h2>
...
function CampSite({backgroundImage, title, subtitle, peopleJoined}: CampProps) {
    return (
